 ...
 * @author neolord
 */
public class CtrlHeaderEndnote extends CtrlHeader implements StreamWritable {
    /**
     * 미주 번호
     */
    private long number;
    ...
    public CtrlHeaderEndnote(StreamReader sr) throws IOException, IllegalAccessException {
        super(ControlType.Endnote.getCtrlId());
