...
import ext.org.apache.poi.hhwpf.util.extractor.TextExtractMethod;
...
public abstract class HWPChar {
    ...
    public String toString() {
        switch (this.getType()) {
            case Normal :
                try {
                    return ((HWPCharNormal) this).getCh();
            ...
            case ControlInline:
                switch (this.code) {
                    ...
                    case 24:
                        return ("_");
                    default:
                        return String.format("\\0x%04X\\", this.code);
                }
            case ControlExtend:
                return String.format("\\Ex0x%04X\\", this.code);
            default:
                return "?";
        }
