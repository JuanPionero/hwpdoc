...
public class LineSegItem {
    ...
    public LineSegItem(long textStartPositionValue,
                       int lineVerticalPositionValue,
                       int lineHeightValue,
                       int textPartHeightValue,
                       int distanceBaseLineToLineVerticalPositionValue,
                       int lineSpaceValue,
                       int startPositionFromColumnValue,
                       int segmentWidthValue,
                       long tagValue) {
        // 기본은  EmptyParagraphAdder.lineSeg( ... )
        this.textStartPosition = textStartPositionValue;
        this.lineVerticalPosition = lineVerticalPositionValue;
        this.lineHeight = lineHeightValue;
        this.textPartHeight = textPartHeightValue;
        this.distanceBaseLineToLineVerticalPosition = distanceBaseLineToLineVerticalPositionValue;
        this.lineSpace = lineSpaceValue;
        this.startPositionFromColumn = startPositionFromColumnValue;
        this.segmentWidth = segmentWidthValue;
        this.tag = new LineSegItemTag(tagValue);
    }

    public LineSegItem(StreamReader sr) throws IOException {
        this.textStartPosition = sr.readUInt4();
        this.lineVerticalPosition = sr.readSInt4();
        this.lineHeight = sr.readSInt4();
        this.textPartHeight = sr.readSInt4();
        this.distanceBaseLineToLineVerticalPosition = sr.readSInt4();
        this.lineSpace = sr.readSInt4();
        this.startPositionFromColumn = sr.readSInt4();
        this.segmentWidth = sr.readSInt4();
        this.tag = new LineSegItemTag( sr );
    }
