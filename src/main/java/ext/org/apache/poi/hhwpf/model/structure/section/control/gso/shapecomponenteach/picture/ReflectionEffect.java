 ...
 * @author neolord
 */
public class ReflectionEffect implements StreamWritable {
    /**
     * 반사 스타일 (정보 없음)
     */
    private int style;
    ...
    public ReflectionEffect(StreamReader sr) throws IOException {
        this.style = sr.readSInt4();
        this.radius = sr.readFloat();
        this.direction = sr.readFloat();
        this.distance = sr.readFloat();
        this.tiltAngleX = sr.readFloat();
        this.tiltAngleY = sr.readFloat();
        this.zoomRateX = sr.readFloat();
        this.zoomRateY = sr.readFloat();
        this.rotationStyle = sr.readSInt4();
        this.startTransparency = sr.readFloat();
        this.startPosition = sr.readFloat();
        this.endTransparency = sr.readFloat();
        this.endPosition = sr.readFloat();
        this.offsetDirection = sr.readFloat();
    }
    ...
    public void write(StreamWriter sw) throws IOException {
        sw.writeSInt4(this.getStyle());
        sw.writeFloat(this.getRadius());
        sw.writeFloat(this.getDirection());
        sw.writeFloat(this.getDistance());
        sw.writeFloat(this.getTiltAngleX());
        sw.writeFloat(this.getTiltAngleY());
        sw.writeFloat(this.getZoomRateX());
        sw.writeFloat(this.getZoomRateY());
        sw.writeSInt4(this.getRotationStyle());
        sw.writeFloat(this.getStartTransparency());
        sw.writeFloat(this.getStartPosition());
        sw.writeFloat(this.getEndTransparency());
        sw.writeFloat(this.getEndPosition());
        sw.writeFloat(this.getOffsetDirection());
    }
}
