package ext.org.apache.poi.hhwpf.model.structure.section.control.headerfooter;
 ...
 * @author neolord
 */
public class ListHeaderForHeaderFooter implements StreamWritable {
    /**
     * 문단 개수
     */
    ...
    public ListHeaderForHeaderFooter(StreamReader sr) throws IOException {
        sr.readDataRecordHeader();
        if(sr.getCurrentDataRecordHeader().getTagID() != HWPTAG_LIST_HEADER) {
            throw new UnexpectedFileFormatException("Unexpected DataRecordHeader in ListHeaderForHeaderFooter");
        }
