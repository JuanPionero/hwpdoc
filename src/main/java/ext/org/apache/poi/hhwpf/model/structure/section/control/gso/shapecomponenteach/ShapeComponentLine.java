 ...
 * @author neolord
 */
public class ShapeComponentLine implements StreamWritable {
    /**
     * 시작점 x 좌표
     */
    private int startX;
    ...
    public ShapeComponentLine(StreamReader sr) throws IOException {
        ...
        if (temp == 1) {
            this.startedRightOrBottom = true;
        }
    }
