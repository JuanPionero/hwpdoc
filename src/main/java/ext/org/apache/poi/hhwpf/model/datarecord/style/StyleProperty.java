package ext.org.apache.poi.hhwpf.model.datarecord.style;
...
public class StyleProperty {
    ...
    public StyleProperty(short value) {
        this.value = value;
    }

    public StyleProperty(StreamReader sr) throws IOException {
        this.value=sr.readUInt1();
    }
