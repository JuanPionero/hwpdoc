package ext.org.apache.poi.hhwpf.model.structure.section.control.ctrlheader.gso;
...
public class GsoHeaderProperty {
    ...
    public GsoHeaderProperty( long value ) throws IOException {
        this.value = value;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("GsoHeaderProperty{");
        sb.append("value=").append(String.format("%16o",value));
        sb.append('}');
        return sb.toString();
    }
}
