...
public class StreamWriter implements Closeable {
    ...
    public StreamWriter(String name, boolean compress, FileVersion fileVersion, DocInfo docInfo) {
        this.name = name;
    ...
    public StreamWriter(String name, boolean compress, FileVersion fileVersion) {
        this(name, compress, fileVersion, null);
    }
     ...
     * @throws IOException
     */
    public void writeDataRecordHeader(int tagID, long size) throws IOException {
        long header = 0;
