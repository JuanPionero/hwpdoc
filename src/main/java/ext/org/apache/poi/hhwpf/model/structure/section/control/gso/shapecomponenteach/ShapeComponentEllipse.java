...
import ext.org.apache.poi.hhwpf.model.structure.section.control.gso.shapecomponenteach.ellipse.ShapeComponentEllipseProperty;
 ...
 * @author neolord
 */
public class ShapeComponentEllipse implements StreamWritable {
    /**
     * 속성
     */
    ...
    public ShapeComponentEllipse(StreamReader sr) throws IOException {
        property = new ShapeComponentEllipseProperty(sr.readUInt4());
         this.centerX = sr.readSInt4();
         this.centerY = sr.readSInt4();
         this.axis1X = sr.readSInt4();
         this.axis1Y = sr.readSInt4();
         this.axis2X = sr.readSInt4();
         this.axis2Y = sr.readSInt4();
         this.startX = sr.readSInt4();
         this.startY = sr.readSInt4();
         this.endX = sr.readSInt4();
         this.endY = sr.readSInt4();
         this.startX2 = sr.readSInt4();
         this.startY2 = sr.readSInt4();
         this.endX2 = sr.readSInt4();
         this.endY2 = sr.readSInt4();
    }
    ...
    public void write(StreamWriter sw) throws IOException {
        sw.writeDataRecordHeader(TagID.HWPTAG_SHAPE_COMPONENT_ELLIPSE, 60);
        sw.writeUInt4(this.getProperty().getValue());
        sw.writeSInt4(this.getCenterX());
        sw.writeSInt4(this.getCenterY());
        sw.writeSInt4(this.getAxis1X());
        sw.writeSInt4(this.getAxis1Y());
        sw.writeSInt4(this.getAxis2X());
        sw.writeSInt4(this.getAxis2Y());
        sw.writeSInt4(this.getStartX());
        sw.writeSInt4(this.getStartY());
        sw.writeSInt4(this.getEndX());
        sw.writeSInt4(this.getEndY());
        sw.writeSInt4(this.getStartX2());
        sw.writeSInt4(this.getStartY2());
        sw.writeSInt4(this.getEndX2());
        sw.writeSInt4(this.getEndY2());
    }
}
