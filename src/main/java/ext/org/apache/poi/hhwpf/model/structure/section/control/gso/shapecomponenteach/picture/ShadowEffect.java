 ...
 * @author neolord
 */
public class ShadowEffect implements StreamWritable {
    /**
     * 그림자 스타일 (정보 없음)
     */
    private int style;
    ...
    public void write(StreamWriter sw) throws IOException {
        ...
        sw.writeSInt4(this.getRotateWithShape());
