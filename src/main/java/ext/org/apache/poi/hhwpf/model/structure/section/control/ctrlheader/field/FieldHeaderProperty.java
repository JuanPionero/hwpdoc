package ext.org.apache.poi.hhwpf.model.structure.section.control.ctrlheader.field;
...
public class FieldHeaderProperty {
    ...
    public FieldHeaderProperty(long value) {
        this.value = value;
    }
     ...
     *
     * @param updateTextPropertyAtUpdatingHyperlinkNotOpened 열어보지 않은 하이퍼링크 필드 업데이트 시
     *                                                       글자 속성 업데이트 여부
     */
     ...
     *
     * @param updateTextPropertyAtUpdatingHyperlinkOpened 열어본 하이퍼링크 필드 업데이트 시 글자 속성
     *                                                    업데이트 여부
     */
