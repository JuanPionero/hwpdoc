...
public class CharOffsets {
    ...
    public CharOffsets(byte charOffset) {
        this();
        this.setForAll(charOffset);
    }

    public CharOffsets(StreamReader sr) throws IOException {
        this.array = new byte[7];
        for (int index = 0; index < 7; index++) {
            this.array[index] = sr.readSInt1();
        }
    }
