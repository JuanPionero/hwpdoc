 ...
 * @author neolord
 */
public class ShapeComponentRectangle implements StreamWritable {
    /**
     * 모서리 둥근 비율
     */
    ...
    public ShapeComponentRectangle(StreamReader sr) throws IOException {
         this.roundRate = sr.readSInt1();
    ...
    public void write(StreamWriter sw) throws IOException {
        sw.writeDataRecordHeader(TagID.HWPTAG_SHAPE_COMPONENT_RECTANGLE, 33);
        sw.writeSInt1(this.getRoundRate());
